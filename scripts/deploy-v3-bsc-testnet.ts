...
async function main() {
  ...
  console.log("Deploying MessageMarketplaceV3 to BSC Testnet...");
  ...
  console.log("\nDeployment info saved to deployment-info-v3-bsc-testnet.json");
  const fs = require("fs");
  fs.writeFileSync(
    "deployment-info-v3-bsc-testnet.json", 
