...
async function main() {
  ...
  console.log("Upgrading MessageMarketplace to V3 on Ethereum Sepolia...");
  ...
  try {
    deploymentInfo = JSON.parse(fs.readFileSync("deployment-info-sepolia.json", "utf8"));
  ...
  console.log("\n" + "=".repeat(60));
  console.log("UPGRADE SUMMARY - ETHEREUM SEPOLIA");
  ...
  const outputFile = "upgrade-info-v3-sepolia.json";
