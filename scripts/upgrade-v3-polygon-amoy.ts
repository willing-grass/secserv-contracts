...
async function main() {
  ...
  console.log("Upgrading MessageMarketplace to V3 on Polygon Amoy...");
  ...
  try {
    deploymentInfo = JSON.parse(fs.readFileSync("deployment-info-polygon-amoy.json", "utf8"));
  ...
  console.log("\n" + "=".repeat(60));
  console.log("UPGRADE SUMMARY - POLYGON AMOY");
  ...
  const outputFile = "upgrade-info-v3-polygon-amoy.json";
