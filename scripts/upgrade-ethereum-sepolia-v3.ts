...
async function main() {
  console.log("🔄 Upgrading Ethereum Sepolia V3 contract with message hash functionality...");
  ...
  const deploymentInfo = require("../deployment-info-sepolia.json");
  ...
  try {
    ...
    const testMessageId = ethers.keccak256(ethers.toUtf8Bytes("test-ethereum-upgrade"));
    ...
    console.log("\n✅ Ethereum Sepolia V3 contract upgrade completed successfully!");
