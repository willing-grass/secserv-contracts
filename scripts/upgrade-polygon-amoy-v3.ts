...
async function main() {
  console.log("🔄 Upgrading Polygon Amoy V3 contract with message hash functionality...");
  ...
  const deploymentInfo = require("../deployment-info-polygon-amoy.json");
  ...
  try {
    ...
    const testMessageId = ethers.keccak256(ethers.toUtf8Bytes("test-polygon-upgrade"));
    ...
    console.log("\n✅ Polygon Amoy V3 contract upgrade completed successfully!");
