...
async function main() {
  ...
  console.log("Upgrading MessageMarketplace to V3 on BSC Mainnet...");
  ...
  console.log("\nVerifying new implementation on BSCScan...");
  try {
  ...
  console.log("\nDeployment info updated in deployment-info-bsc-mainnet.json");
  const fs = require("fs");
  fs.writeFileSync(
